...
const step1Script: DemoScript = {
  ...
  steps: [
    ...
    },
    {
      id: 's1-intro',
      label: 'JWT bevezető',
      action: { type: 'highlight', selector: '.content-items > :nth-child(1)' },
      tooltip: {
        title: 'Mi az a JWT?',
      ...
      highlight: { selector: '.content-items > :nth-child(1)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's1-header',
      label: 'Header',
      action: { type: 'highlight', selector: '.content-items > :nth-child(2)' },
      tooltip: {
        title: 'HEADER (Fejléc)',
      ...
      highlight: { selector: '.content-items > :nth-child(2)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's1-payload',
      label: 'Payload',
      action: { type: 'highlight', selector: '.content-items > :nth-child(3)' },
      tooltip: {
      ...
      highlight: { selector: '.content-items > :nth-child(3)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's1-signature',
      label: 'Signature',
      action: { type: 'highlight', selector: '.content-items > :nth-child(4)' },
      tooltip: {
      ...
      highlight: { selector: '.content-items > :nth-child(4)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's1-usage',
      label: 'Használat a projektben',
      action: { type: 'highlight', selector: '.content-items > :nth-child(5)' },
      tooltip: {
      ...
      highlight: { selector: '.content-items > :nth-child(5)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's1-code',
      label: 'TypeScript interfészek',
      action: { type: 'highlight', selector: '.step-body > :nth-child(2)' },
      tooltip: {
      ...
      highlight: { selector: '.step-body > :nth-child(2)', padding: 8, scrollIntoView: true }
    }
  ]
};
...
const step2Script: DemoScript = {
  ...
  steps: [
    ...
    },
    {
      ...
      action: { type: 'highlight', selector: '.content-items > :nth-child(6)' },
      tooltip: {
      ...
      highlight: { selector: '.content-items > :nth-child(6)', padding: 8, scrollIntoView: true }
    },
    {
      id: 's2-component',
    ...
    },
    {
      ...
      action: { type: 'highlight', selector: '.step-body > :nth-child(3)' },
      tooltip: {
      ...
      highlight: { selector: '.step-body > :nth-child(3)', padding: 8, scrollIntoView: true }
    }
  ]
};
...
const step3Script: DemoScript = {
  ...
  steps: [
    ...
    },
    {
      ...
      action: { type: 'highlight', selector: '.step-body > :nth-child(4)' },
      tooltip: {
      ...
      highlight: { selector: '.step-body > :nth-child(4)', padding: 8, scrollIntoView: true }
    }
  ]
};
